...
level1 = {
     spawns = [ { position = vec2 120 40, dir = 1, type_ = Player (PlayerData 0)}, { position = vec2 704 120, dir = 1, type_ = Gem}, { position = vec2 268 68, dir = 1, type_ = Gem}, { position = vec2 520 120, dir = 1, type_ = Gem} ]
