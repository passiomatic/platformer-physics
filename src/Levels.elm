...
level1 = {
     ...
     --, platforms = [ { position = vec2 544 136, width = 128, height = 16, maxOffset = 100, period = 3.5}, { position = vec2 96 280, width = 128, height = 16, maxOffset = -100, period = 4} ]
     , platforms = [ { position = vec2 544 136, width = 128, height = 16, maxOffset = 100, period = 3.5} ]
    }
