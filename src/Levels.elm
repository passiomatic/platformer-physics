...
level1 = {
    ...
    , platforms = [ { startPosition = vec2 544 136, width = 128, height = 16, offset = vec2 0 150, period = 3}, { startPosition = vec2 96 280, width = 128, height = 16, offset = vec2 0 -100, period = 4} ]
    }
